...
-   Dedicated coprocessor for vision processing (PhotonVision or LimelightVision)

> [!WARNING]
> Running vision processing directly on the roboRIO is **highly discouraged**. Substantial CPU and timing tradeoffs make it unsuitable for competition. Use PhotonVision or LimelightVision on a dedicated coprocessor instead.
> Though, we do provide example code for running WPILib ControllerVision on the roboRIO for testing and simulation purposes only. Again, this is not recommended for competition use.
