 ...
 * cameras in FRC.
 * This library supports all Limelight features including AprilTag tracking, Neural Networks, and
...
public class LimelightHelpers {
    ...
    public static URI getLimelightURLString(String tableName, String request) {
     ...
     * IMU data is formatted as [robotYaw, Roll, Pitch, Yaw, gyroX, gyroY, gyroZ, accelX, accelY,
     * accelZ].
     ...
     * @param pitchRate
     *            (Unnecessary) Angular velocity of robot pitch in degrees per second
     * @param roll
    ...
    private static boolean SYNCH_TAKESNAPSHOT(String tableName, String snapshotName) {
        URI url = getLimelightURLString(tableName, "capturesnapshot");
        try {
