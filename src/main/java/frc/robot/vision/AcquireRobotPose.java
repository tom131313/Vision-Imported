...
public class AcquireRobotPose {
    ...
    public AcquireRobotPose(ControllerVision roboRIOCamera, boolean usePose3D,
        ...
        Config poseEstConfig = new AprilTagPoseEstimator.Config(tagSize, roboRIOCamera.cameraFx, roboRIOCamera.cameraFy,
                roboRIOCamera.cameraCx, roboRIOCamera.cameraCy);
