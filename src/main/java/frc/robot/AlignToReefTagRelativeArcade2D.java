 ...
 * 
 * <p>
 * This is an example for only one AprilTag and that is determined in the code.
 * 
 * <p>
 * Related references:
 * <p>
 ...
 * the rotation of the robot wrt the tag. The author of the code below must somehow relate the
 * robot orientation with the tag orientation while in 2-D mode.
 * 
