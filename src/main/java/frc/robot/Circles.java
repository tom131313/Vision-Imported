/**
 *agent ransack search Siemen -- guidance has more code to use
 */ 
package frc.robot;
...
public class Circles {
    ...
    /**
     * Creates an OpenCV Mat format of a Siemens Star for use of focussing a camera.
     * <p>Note that as the radii approach the center there is incorrect appearance
     * because of the loss of resolution.
     * @return Mat containing a Siemens Star
     */
