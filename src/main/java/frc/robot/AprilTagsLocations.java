 ...
 * <p>
 * Example drive commands somewhat assumed 2025 Reefscape so that is hard-wired in place of
 * kDefaultField that will be different in 2026.
 * 
 * <p>
        ...
        try {
            if (CustomTagLayout)
                ...
                aprilTagFieldLayout = AprilTagFieldLayout
                        .loadField(AprilTagFields.k2025ReefscapeWelded/* kDefaultField */);
        } catch (IOException e) {
            e.printStackTrace();
