...
/**
   ...
   * shares a thread with AcquireAprilTag and runs sequentially with it.
   *
...
public class AcquireRobotPose {
  ...
  private ControllerVision roboRIOCamera;
  ...
  public void run() {
     ...
     * <p>Lock the list while it's being read so updates can't happen simultaneously in {@link #run()}
