 ...
 * <p>getImage() method has a thread wait until a new image is set (blocking).
 * [disabled for this single threaded vision set and get use]
 * <p>Multi-Thread-Safe version (overkill if that isn't needed)
...
public class Image {
   ...
   */
      ...
      public /*synchronized*/ void setImage(Mat mat, AprilTagDetection[] detections, double acquisitionTime, int frameNumber)
            {
                mat.copyTo(this.mat);
